...
describe('query > escape', async () => {
  ...
  it('should escape filter parameters', async () => {
    ...
    expect(loadModelQuery).to.be.equalIgnoreCase(`SELECT * FROM model as t0 WHERE ( ( t0.name = ' \\% name \\' \\" ' ) )`);
  });
  ...
  it('should escape ignore percentage symbol in like', async () => {
    ...
    expect(loadModelQuery).to.be.equalIgnoreCase(`SELECT * FROM model as t0 WHERE ( ( t0.name LIKE ' % name \\' \\" ' ) )`);
  });
  ...
  it('should be able to query short date', async () => {
    ...
    expect(loadModelQuery).to.be.equalIgnoreCase(`SELECT * FROM model as t0 WHERE ( ( t0.createdDate > '1990-07-06 00:00:00' ) )`);
  });
  ...
  it('should be able to query long date', async () => {
    ...
    let loadModelQuery = ctx.models.where(x => x.createdDate().gt(date)).toList.query;
    expect(loadModelQuery).to.be.equalIgnoreCase(`SELECT * FROM model as t0 WHERE ( ( t0.createdDate > '1990-07-06 23:58:24' ) )`);
  });
});
