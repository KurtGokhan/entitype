...
declare interface TypesDefinition {
  string?: string[];
  number?: string[];
  // TODO: Check other types.
}

declare interface VorpalFactory {
  new(): VorpalInstance;
...
declare interface VorpalInstance {
   ...
   */
  parse(argv: string | string[], options?: { use?: 'minimist' }): any;
...
declare function RedrawMethod(text: string): void;
declare function RedrawMethod(...texts: string[]): void;
